defmodule PhoenixElmJukebox.Presence do
  @moduledoc """
  ...
  Presences can be tracked in your channel after joining:
      ...
      defmodule PhoenixElmJukebox.MyChannel do
        use PhoenixElmJukebox.Web, :channel
        alias PhoenixElmJukebox.Presence
  ...
  """
  use Phoenix.Presence, otp_app: :phoenix_elm_jukebox,
                        pubsub_server: PhoenixElmJukebox.PubSub
end
